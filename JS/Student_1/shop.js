...
function ready(){   //this function is used to give the functionality to buttons in the shop page after loading the page
...
function addToCartClicked(event){ //updating the cart when a product is added to the cart from the store
    ...
    var imageSrc = shopItem.getElementsByClassName('shop-item-image')[0].src //getting the image source of the product from the store
...
function addItemToCart(title,price,imageSrc){    //adding items to cart with the title,price and image
    ...
    //saving a html code as a Sring using `` 
    var cartRowContents = `                                         
